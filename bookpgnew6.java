...
class bookpgnew6 extends Frame implements ActionListener,ItemListener
{
  ...
  JComboBox<String> selectMovieOptions, selectTimeOptions, selectSofaOptions;
    ...
    String[] movie = {"Select movie", "Badrinath Ki Dulhaniya","Aaja Nachale","Beiimaan Love","Don","Jooniyat","Prem Ratan Dhan Payo","Creature","Love Aaj Kal","Chennai Express","Dilwale","Andhadhun","Kung Fu Yoga"};
