...
class bookpgnew4 extends Frame implements ActionListener,ItemListener
{
   ...
   JComboBox<String> selectMovieOptions, selectTimeOptions, selectSofaOptions;
    ...
    String[] movie = {"Select movie", "Fast and Furious 9","The Conjuning","Spider-Man","Zack Synder's","The Suicide Squad","Sanam Teri Kasam","Bunty Or Bubli","War","Wrath Of Man","Drishyam","Bajirao Mastani","Hitman's Wife's"};
